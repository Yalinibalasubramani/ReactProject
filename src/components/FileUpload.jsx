      ...
      <div className='bga'></div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <h3 className='ppp'>Current Health Status(Medical Certificate)</h3>
            ...
            <Button variant="outlined" style={{backgroundColor:'violet',color:'black',fontSize:'20px',cursor:'pointer',border:'3px solid black',borderRadius:'10px'}} type='submit'>Submit</Button>
            <Snackbar
                open={open}
